...
fun AddMedNotificationsScreen(
    ...
    var notificationsPattern by remember { mutableStateOf<List<UsageFormat>>(emptyList()) }
    ...
    Scaffold(
        ...
        Column(
            ...
            Column {
                ...
                LazyColumn {
                    notificationsPattern.forEachIndexed { index, usage ->
                        item {
                            NotificationItem(
                                time = usage.timeInMinutes,
                                quantity = usage.quantity,
                                form = state.remedy.type,
                                forms = forms,
                                onDelete = {
                                    notificationsPattern = notificationsPattern
                                        .minus(notificationsPattern[index])
                                },
                                onDoseChange = { q ->
            ...
            ReUseFilledButton(
                ...
                sendEvent(CreateCourseContract.Event.UpdateUsagesPattern(notificationsPattern))
